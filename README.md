...
* 变化音级（变音）。升高或降低基本音级而得来的音级。键盘的黑色琴键。有时，不同的音级代表同一个音高，如#E和F、B和bC、#G和bA等。这样关系的音级互为等音
...
![img](README.assets/20190228180424132.png)     ![img](README.assets/20190228180851665.png)     ![img](README.assets/20190228181729440.png)    ![img](README.assets/20190228182027144.png)
...
右边B-F 低八度，转成左边 F-B
 ...
 ![img](README.assets/20190228182445559.png)

规律1：度数相加等于九（右边B-F为减五，左边F-B为增四，4+5=9）

规律2：大小增减是互换（大->小，减->增）

规律3：纯音程不变（比如纯4->纯5）![img](README.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L211eWFvOTg3,size_16,color_FFFFFF,t_70.png)   ->![img](README.assets/20190228183136394.png)

快速识别跨度大的音程：将两个音中的一个音进行转为（升高或降低八度），然后通过公式“转位前的度数+转位后的度数=9度”。属性则如下公式颠倒：大—>小、小—>大、增—>减、减—>增、倍增—>倍减、倍减—>倍增、纯—>纯。
...
节奏（Rhythm）：长音和短音有规律地组合在一起。

速度：如80bpm（beats per minute）、120bmp，每分钟多少拍

小节：在乐曲中, 由一个强拍到下一个强拍之间的部分。一定数量的拍组合成小节（4/4：4拍为1节）

节拍与节奏总是交织在一起的 ，那节拍体现出来周期性的特点 ,它是比较静止的；那么节奏是可以多样化的，它体现出无限的可变性，所以节拍和节奏就是一静一动

### 节拍

作用：重拍和弱拍周期性的有规律的重复进行

单位拍：用某种固定时值的音符来表示节拍中的每一个时间片段，即“一拍”。单位拍内也有强位、弱位之分。 

拍号：表示节拍的记号。它由上下两个数字组成，下方数字代表单位拍的音符时值，上方数字代表单位拍的数量即拍子。 
...
| 名称   | 含义       | 强弱关系            | 效果                                               |
| ------ | ---------- | ------------------- | -------------------------------------------------- |
| 二拍子 | 每小节两拍 | 强—弱               | 表现方整、对称、顽强、刚健、有力。如进行曲、曲军乐 |
| 三拍子 | 每小节三拍 | 强—弱—弱            | 表现优美、流畅、灵活自由。如圆舞曲                 |
...
单拍子：每小节只有一个强拍的拍子。 如二拍子、三拍子

复拍子：两个或两个以上同类型单拍子的组合。如四拍子、六拍子

混合拍子：两个或两个以上不同类型单拍子的组合。 如五拍子、七拍子
...
![img](README.assets/u=2936520617,3204552699&fm=26&gp=0.jpg)
...
![img](README.assets/20190301102748616.png)(同主音)
...
![img](README.assets/20190301124050200.png)

###  关系大小调

![img](README.assets/20190301103555788.png)

大调音阶的六级（主音的下方小三度，比如C下方小三度为A，所以C大调的关系小调是a小调） = 关系小调的主音

例子：C大调是a小调的关系大调，a小调是C大调的关系小调，有多少大调就有多少关系小调。

 ![img](README.assets/20190301104604269.png)图为各大调和小调的对应关系

![img](README.assets/20190301104934614.png)图为调号（和大调调号一样）
...
![image-20200820233746257](README.assets/image-20200820233746257.png)

1、Ionian Mode（伊奥尼亚调式——自然大调音阶）：1、2、3、4、5、6、7 。C大和弦（1357246）能构成伊奥利亚音阶
...
7、Locrian Mode（洛克利亚调式——自然大调7级音阶）：1、b2、b3、4、b5、b6、b7。半减七和弦能构成洛克利亚音阶
...
| ------------------------------------------ | -------------- | ---------------- | --------------- | -------- |
| ![img](README.assets/KTL_493ba7c5_en.gif)  | E - F iii - iv | B - C vii - viii | major           | Cmaj7    |
| ![img](README.assets/KTL_m3796912f_en.png) | E - F ii - iii | B - C vi - vii   | minor           | Dm7(Dm6) |
| ![img](README.assets/KTL_239c080c_en.png)  | E - F i - ii   | B - C v -vi.     | minor           | Em7      |
| ![img](README.assets/KTL_m1cdcd598_en.png) | B - C iv - v.  | E - F vii - viii | major           | Fmaj7    |
| ![img](README.assets/KTL_2d40a74a_en.png)  | B - C iii - iv | E - F vi - vii   | major           | G7       |
| ![img](README.assets/KTL_5ba0801d_en.png)  | B - C ii - iii | E - F v - vi     | minor           | Am7      |
| ![img](README.assets/KTL_m4fad6d13_en.png) | B - C i - ii   | E - F iv - v     | half diminished | BØ7      |
...
![img](README.assets/20190301112517933.png)

4.写***\*和弦构成音\****常犯的错误

![img](README.assets/20190301112846314.png)

注释：F和G#是二度，而和弦构成音按三度关系叠置。

5.写**音阶构成音**常犯的错误（此处“音阶”指大调、小调的音阶）

![img](README.assets/20190301113158736.png)
...
* 纯音程：纯一度、纯四度、纯五度、纯八度（1:2）
* 大音程：大二度、大三度、大六度、大七度
* 小音程：小二度、小三度、小六度、小七度
* 三全音：增四度、减五度

![img](README.assets/20190301115016381.png)

      上表中，根音是下面那个音，冠音是上面那个音。 
...
![img](README.assets/2019030111533183.png)

减音程

![img](README.assets/20190301115414360.png)

倍增音程

![img](README.assets/20190301115501340.png)

倍减音程（特殊情况见第7条）

![img](README.assets/20190301115608705.png)

特殊情况（纯音程）

      纯一只有增一度和倍增一度，没有“减一度”和“倍减一度”！

![img](README.assets/20190301115715130.png)
...
定义：三个音按照三度音程关系叠置。就算在一个三和弦的基础上再添加不同八度但音级相同的音，它仍然是三和弦。
...
* 大七和弦（常见。大大七和弦）：Cmaj7、CM7。大三和弦+大七度
  ...
  ![image-20200814224226856](README.assets/image-20200814224226856.png)
...
* 属七和弦（最常见。从调式的角度）。Cdom7。通常以属音为根音（注意不一定全是以属音为根音，只要满足大小七和弦，人们也习惯叫做属和弦）构成的七和弦，例如在C大调里，属音为G，所以构成的七和弦为GBDF
  ...
  ![image-20200814224313823](README.assets/image-20200814224313823.png)

* 小大七和弦：小三和弦+大七度

  ![image-20200814224727200](README.assets/image-20200814224727200.png)

* 小七和弦（常见。小小七和弦）：Cm7。小三和弦+小七度

  ![image-20200814224436392](README.assets/image-20200814224436392.png)

* 增七和弦（增大七和弦）：增三和弦+大七度

  ![image-20200814224514816](README.assets/image-20200814224514816.png)
...
* 减七和弦（常见。减减七和弦）：Cdim7。减三和弦+减七度
  ...
  ![image-20200814224558755](README.assets/image-20200814224558755.png)
...
sus4（留四）和弦是指三和弦或者七和弦里的三音被四音所取代
...
* 识别和弦级数：X和弦 - X调（C=1，D=2，E=3...）+1，如果结果>0，则它就是结果的级数；如果为<=0，则再+7。如E三和弦，在D大调中，在ii级数（副下属和弦/小三和弦）上，因为E(3) - D(2) + 1= 2；由比如C三和弦，在vii级上（导和弦/减三和弦），因为C(1)-D(2)+1+7=7。
...
| 名称                               | 标记                                          | 组成            | 性质 |
| ---------------------------------- | --------------------------------------------- | --------------- | ---- |
| C大七和弦（Major）                 | Cmaj7、CM7、C△7、~~C7~~（这是属七和弦的标记） | 大三和弦+大七度 |      |
...
在传统的和声学中，自然大调下：将主和弦、下属和弦、属和弦分别标记为T（tonica）, S（subdominant）, D（dominant）.
和声小调下：将主和弦、下属和弦、属和弦分别标记为t, s, D.
...
在大调体系中，有三种和弦族是相当重要的：主和弦、属和弦以及下属和弦。
...
### Voice Leading（声部的横向安排）

含义：内声部旋律的平稳进行（通常是指三度内）
...
1. 先分句（如长音后）
2. 在每一句里找到最高音和最低音，分别分配给大拇指和小拇指，其余音顺手弹
